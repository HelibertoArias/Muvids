...
public class DeleteMovieCommandHandler : IRequestHandler<DeleteMovieCommand>
{
    ...
    public DeleteMovieCommandHandler(IMapper mapper, IMovieRepository movieRepository, ILoggedInUserService loggedInUserService)
    {
    ...
    public async Task<Unit> Handle(DeleteMovieCommand request, CancellationToken cancellationToken)
    {
        ...
        if (movieToDelete == null) { throw new NotFoundException(nameof(Movie), request.Id); }
